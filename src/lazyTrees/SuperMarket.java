...
public class SuperMarket 
{
	...
	public static void main(String[] args) 
	{
		...
		//NOTE: Just a blank text file
		//final String TESTFILE = "resources/inventory_clear.txt";

		//final String TESTFILE = "resources/inventory_delete_all.txt";

		final String TESTFILE = "resources/inventory_add.txt";
